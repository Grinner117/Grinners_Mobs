...
public class DeathSpikeArmorModel extends GeoModel<DeathSpikeArmor> {
    ...
    @Override
    public ResourceLocation getModelResource(DeathSpikeArmor animatable) {
        return new ResourceLocation(GrinnersMobs.MODID, "geo/armor/deathspikearmor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(DeathSpikeArmor animatable) {
        return new ResourceLocation(GrinnersMobs.MODID, "textures/armor/deathspikearmor.png");
    }

    @Override
    public ResourceLocation getAnimationResource(DeathSpikeArmor animatable) {
