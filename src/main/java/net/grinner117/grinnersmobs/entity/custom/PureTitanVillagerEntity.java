...
public class PureTitanVillagerEntity extends Monster implements GeoEntity {
    ...
    private PlayState predicate(AnimationState antimationState) {
        if (antimationState.isMoving()) {
            antimationState.getController().setAnimation(RawAnimation.begin().then("animation.puretitanvillager.walk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }
        antimationState.getController().setAnimation(RawAnimation.begin().then("animation.puretitanvillager.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }
