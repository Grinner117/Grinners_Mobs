...
public class PureTitanLankyEntity extends Monster implements IAnimatable {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.puretitanlanky.idle", true));
        return PlayState.CONTINUE;
    }
    ...
    private PlayState attackPredicate(AnimationEvent event) {
        if (this.swinging && event.getController().getAnimationState().equals(AnimationState.Stopped)) {
            ...
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.puretitanlanky.attack", false));
            this.swinging = false;
        }
        return PlayState.CONTINUE;
    }
