...
public class Speed4_Perk extends ArmorItem {
    public Speed4_Perk(ArmorMaterial material, EquipmentSlot slot, Properties properties) {
    ...
    public void onArmorTick(ItemStack stack, Level world, Player player) {
        if (!world.isClientSide()) {
            player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 4,false, false, true));
        }
    }
    @Override
